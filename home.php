...
<html lang="en">
  ...
  <body>
    ...
    <div class="mobile_nav">
      ...
      <a href="home1.php?id_user=<?php echo $id_user;?>"
          ><i class="fas fa-desktop"></i><span>Mes Modules</span></a >
        <a href="home.php?id_module=<?php echo $id_module;?>&id_user=<?php echo $id_user;?>"
    ...
    <div class="content">
      ...
      <div class="row">
       <?php 
    $sql = "SELECT class_name, id_class, id_module FROM class NATURAL JOIN module_manager WHERE id_module = '$id_module' AND id_user = '$id_user';";
                ...
                <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                    ...
                    <div class="h5 my-2 font-weight-bold text-gray-800">
                      ...
                      <a href="./Absences.php?id_class='.$row["id_class"].'&class_name='.$row["class_name"].'&id_module='.$id_module .'&id_user='.$id_user.'&label='.$label.'" style="text-decoration: none; color: white">
                          <h4>Entrer</h4>
                        </a>
                      </form>  
                      </button>
